<x-master-layout>
    ...
    <body>
        ...
        <div id="createProductPage" class="container-page">
            ...
            <form action="{{ url('categoriess/create') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn btn-success">Create_Product</button>
                <a href="{{ url('categoriess') }}" class="btn btn-secondary">Go Back</a>
